...
void AdminUser::displayMenu(Media *mediaList[], int &mediaCount, CompressedTrie &compressedTrie)
{
    int choice;
    while (true)
    {
        ...
        {
        case 1:
            addMovie(mediaList, mediaCount, compressedTrie);
            break;
        case 2:
            addSeries(mediaList, mediaCount, compressedTrie);
            break;
        case 3:
...
void AdminUser::addMovie(Media *mediaList[], int &mediaCount, CompressedTrie &compressedTrie)
{
...
void AdminUser::addSeries(Media *mediaList[], int &mediaCount, CompressedTrie &compressedTrie)
{
    string name, country, genre, language, plot;
